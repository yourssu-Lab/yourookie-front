      ...
      <StyledFormContainer onSubmit={onSubmit}>
        <StyledSection>
          ...
          <StyledFieldWrapper>
            ...
            <StyledInput placeholder="단체명" {...register('name', { required: true })} />
          </StyledFieldWrapper>
          ...
          <StyledFieldWrapper>
            ...
            <div style={{ display: 'flex', gap: '50px' }}>
              ...
              />
              <StyledEmailCheckButton type="button" onClick={onEmailCheck}>
                이메일 확인
              </StyledEmailCheckButton>
            </div>
            {emailValidated === true && (
            ...
            <div style={{ display: 'flex', gap: '40px', width: '100%' }}>
              <div style={{ flex: 1 }}>
                ...
                <StyledInput
                  ...
                  {...register('reservationPassword', { required: true })}
                />
              </div>
        ...
        <StyledSection>
          <StyledSectionTitle>
            2. 선택 정보{' '}
            <StyledSectionDescription>단체 페이지에 사용되는 정보입니다!</StyledSectionDescription>
          </StyledSectionTitle>
        ...
        {postOrganizationMutation.error && (
          <StyledErrorMessage>
            {
              (postOrganizationMutation.error as AxiosError<{ message: string }>).response?.data
                ?.message
            }
          </StyledErrorMessage>
        )}
        {formState.isSubmitted && !emailValidated && (
          <StyledErrorMessage>이메일 인증을 해주세요</StyledErrorMessage>
        )}

        <StyledSubmitButton type="submit">회원가입</StyledSubmitButton>
      </StyledFormContainer>
    </StyledContainer>
  );
}
