      ...
      <StyledFirstSection>
        <StyledFirstSectionContainer>
          <StyledFirstSectionTextWrapper>
            ...
            <StyledFirstSectionLastText>OPENSSUpot</StyledFirstSectionLastText>
          </StyledFirstSectionTextWrapper>
      ...
      <StyledSecondSection>
        <StyledSecondSectionTextWrapper>
          <div style={{ display: 'flex', gap: '21px', alignItems: 'center' }}>
            <StyledSecondSectionFirstText>OPENSSUpot</StyledSecondSectionFirstText>
            <StyledSecondSectionSecondText>서비스 소개</StyledSecondSectionSecondText>
          </div>
          <StyledSecondSectionThirdText>
            오픈SSU팟으로 더 쉽게 운영하세요
          </StyledSecondSectionThirdText>
